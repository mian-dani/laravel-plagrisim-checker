                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div
                            ...
                            <h6 class="text-white text-capitalize ps-3">check Plagiarism</h6>
                        </div>
                    </div>
                    {{-- <div class="p-4 bg-light"> --}}
                    <form class="m-3 mb-4" action="{{ route('plagiarism.store') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3 text-center">
                                    ...
                                    <button type="submit" class="btn btn-primary m-2">Check</button>

                    ...
                    <li>
                      ...
                      <div class="dropdown-cart">
                        <table class="table cart-table-list table-responsive">
                          <tbody>
                            <tr>
                              <td><a href="#"><img alt="" src={{asset("site/assets/images/products/sm1.jpg")}}></a></td>
                            ...
                            <tr>
                              <td><a href="#"><img alt="" src={{asset("site/assets/images/products/sm2.jpg")}}></a></td>
                              <td><a href="#"> Product Title</a></td>
                              <td>X2</td>
                              <td>$ 70.00</td>
                              <td><a class="close" href="#"><i class="fa fa-close font-13"></i></a></td>
    ...
    <div class="container pt-0 pb-0">
      <div class="row">
        <div class="col-xs-12 col-sm-4 col-md-5">
          <div class="widget no-border m-0">
            <a class="menuzord-brand pull-left flip xs-pull-center mb-15" href="{{route('welcome.page')}}"><img src={{asset("site/assets/images/logo-wide.png")}} alt=""></a>
          </div>
        </div>
      ...
      <div class="container">
        <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive">
          <ul class="menuzord-menu">
            <li class="active"><a href="{{route('welcome.page')}}">Home</a>
              {{-- <ul class="dropdown">
          ...
          <ul class="pull-right flip hidden-sm hidden-xs">
            <li>
              ...
              <a class="btn btn-colored btn-flat bg-theme-color-2 text-white font-14 bs-modal-ajax-load mt-0 p-25 pr-15 pl-15" data-toggle="modal" data-target="#BSParentModal" href="{{ route('login') }}">Login</a>
              <!-- Modal: Book Now End -->
            </li>
          </ul>
